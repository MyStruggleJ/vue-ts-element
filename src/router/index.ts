...
//质检
  {
    ...
    name: 'ZhiJian',
    component: Layout,
    redirect: '/ZhiJian/ZhiKongXMSD',
    children: [
      {
        path: '/ZhiJian/ZhiKongXMSD',
        component: () => import(/* webpackChunkName: "error" */ '../views/ZhiJian/ZhiKongXMSD.vue'),
        meta: {
          title: 'ZhiKongXMSD',
          showLink: false,
          savedPosition: true
      ...
      {
        path: '/ZhiJian/ZKPinWeiHu',
        component: () => import(/* webpackChunkName: "error" */ '../views/ZhiJian/ZKPinWeiHu.vue'),
        meta: {
          title: 'ZKPinWeiHu',
          showLink: false,
          savedPosition: true
